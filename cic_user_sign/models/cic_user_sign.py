...
class ResUsers(models.Model):
    ...
    allowed_digital_sign_ids = fields.One2many('cic.allowed.signs', 'user_id', string="Digital Signing Authority(Managers)")
